-- Exercício feito e comentado pelo Instrutor!!
...
values ("Jhonatan Siqueira", "1995-09-22", "09:27:17", "jhonatan.siqueira@teste.com", CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()); 

insert into tb_funcionarios (nome, data_nasc, hora_nasc, email, data_criacao, data_atualizacao) 
values ("Sandra Moura", "1974-05-30", "07:44:22", "sandra.moura@teste.com", CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
